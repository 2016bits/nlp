...
from scripts.data.tables import Table
from scripts.utils.data_utils import read_data_from_json_files, Dataset
...
def get_dpr_files(source_name) -> List[str]:
    if os.path.exists(source_name) or glob.glob(source_name):
        ...
        from scripts.data.download_data import download
